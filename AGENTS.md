...
- **URL map**: client and admin share `/bookings*` (CRUD). Hotel app lives under **`/hotel/*`** (inbox, scan, stays). Admin console under **`/admin/*`** (users, hotels, clients, countries, ranks, vessels, booking reports).
