...
import type {SearchSelectOption as Option} from '@/components/ui/search-select';
        ...
        <PageLayout title="Edit Booking" backHref={toUrl(bookingsIndex())}>
            ...
            <div className="mx-auto w-full max-w-6xl px-0 sm:px-1">
                <header className="mb-6 sm:mb-8">
                    <h2 className="text-xl font-bold tracking-tight text-foreground sm:text-2xl">Edit booking</h2>
                    <p className="mt-1.5 max-w-2xl text-[13px] leading-relaxed text-muted-foreground sm:text-[14px]">
                        Update stay details, crew assignment, and guest. Changes apply as soon as you save.
                    </p>
                </header>
                ...
                <form onSubmit={submit} className="grid grid-cols-1 gap-5 lg:grid-cols-12 lg:gap-6 lg:items-start">
                    <div className="flex flex-col gap-5 lg:col-span-7">
                        <FormSectionCard
                            eyebrow="Property"
                            title="Hotel"
                            description="Change the property for this stay, or leave unset if still flexible."
                        >
                            <div>
                                <Label htmlFor="edit_booking_hotel" className={`${fieldLabelCls} mb-2 flex flex-wrap items-center gap-x-1`}>
                                    Hotel name
                                    <OptionalBadge />
                                </Label>
                                <div id="edit_booking_hotel">
                                    <SearchSelect
                                ...
                                <FieldHint className="mt-2">Use “No hotel” when the property is not confirmed.</FieldHint>
                        ...
                        <FormSectionCard
                            eyebrow="Stay"
                            title="Dates & room"
                            description="Adjust planned check-in, check-out, and room type."
                        >
                            <div className="grid min-w-0 grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-5">
                                <div className="min-w-0 space-y-2">
                                    <Label htmlFor="edit_check_in" className={fieldLabelCls}>
                                        Check-in
                                    </Label>
                                    <Input
                                        id="edit_check_in"
                                ...
                                <div className="min-w-0 space-y-2">
                                    <Label htmlFor="edit_check_out" className={fieldLabelCls}>
                                        Check-out
                                    </Label>
                                    <Input
                                        id="edit_check_out"
                            ...
                            <div>
                                ...
                                <FieldHint className="mb-3">Single, twin, or triple occupancy.</FieldHint>
                    ...
                    <div className="flex flex-col gap-5 lg:col-span-5">
                        <FormSectionCard
                            eyebrow="Crew"
                            title="Rank & vessel"
                            description="Keeps reporting aligned with the seafarer’s rank and vessel."
                        >
                        ...
                        <FormSectionCard
                            ...
                            description="Change the guest record linked to this booking, or create a new one from search."
                        >
                            <div className="space-y-2">
                    ...
                    <div className="rounded-2xl border border-border/40 bg-muted/20 p-4 sm:flex sm:items-center sm:justify-between sm:p-5 lg:col-span-12">
                        <p className="mb-3 text-[12px] text-muted-foreground sm:mb-0 sm:max-w-md sm:pr-4">
                            Saving updates this request for the hotel inbox and your records.
                        </p>
                        <Button
                            type="submit"
                            disabled={processing}
