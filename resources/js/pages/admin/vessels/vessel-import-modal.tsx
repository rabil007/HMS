                ...
                <DialogHeader className="shrink-0">
                    ...
                    <DialogDescription>
                        {step === 'upload'
                            ...
                            : `${previewRows.length} vessel${previewRows.length !== 1 ? 's' : ''} found. Review and select the ones you want to import.`}
                    </DialogDescription>
                </DialogHeader>
                                ...
                                {visibleRows.length === 0 ? (
                                    <div className="flex flex-col items-center justify-center py-12 text-center">
                                        ...
                                        <p className="text-xs text-muted-foreground mt-1">
                                            {activeTab === 'duplicates' ? 'No duplicate vessels found — great!' : 'All vessels are duplicates.'}
                                        </p>
                                    </div>
                                ) : (
                                    visibleRows.map(({ row, globalIndex }) => {
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                <span className={`flex-1 text-[13px] ${checked ? 'font-medium text-foreground' : 'text-muted-foreground'}`}>
                                                    {row.name}
                                                </span>
                        ...
                        <>
                            ...
                            <Button onClick={handleImport} disabled={selectedIndices.size === 0 || importing}>
                                {importing ? (
                                    ...
                                    `Import ${selectedIndices.size} Vessel${selectedIndices.size !== 1 ? 's' : ''}`
                                )}
                            </Button>
                        </>
                    )}
